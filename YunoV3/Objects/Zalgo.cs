...
namespace YunoV3.Objects
{
    public class Zalgo
    {
        ...
        public string GetZalgo(string input)
        {
            ...
            foreach(var letter in input)
            {
                ...
                for (int i = 0; i < _rand.Next(3,6); i++)
                {
                    ...
                    str += ZalgoUp[_rand.Next(0, ZalgoUp.Length)];
                    str += ZalgoMid[_rand.Next(0, ZalgoMid.Length)];
                    str += ZalgoDown[_rand.Next(0, ZalgoDown.Length)];
